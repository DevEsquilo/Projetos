...
int i = 0, nx_1 = 150, ny_1 = 400, size, fx = 0, fy = -1320;
char t = 0;
int pg = 0;
...
void img()
{
    ...
    getimage(0, 0, 235,225, bmp[0]);
    getimage(0, 0, 235,225, mask[0]);
    ...
    getimage(0, 0, 235,225, mask[1]);
    PreparaImg(size, bmp[1], mask[1]);
    cleardevice();
    printf("chegou aqui t1 bmp mask 1\n");
