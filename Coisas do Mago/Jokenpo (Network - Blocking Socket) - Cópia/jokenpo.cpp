...
int main()
{
    ...
    if(entrada == 0)  //Verifica se o usuário escolheu usar o jogo como Client;
    {
        ...
        while (client)
        {
            ...
            SockAddr.sin_addr.s_addr = inet_addr("192.168.1.101");//*((unsigned long*) host -> h_addr); Configuracao de endereco de IP, substituir depois do igual por: inet_addr("192.168.0.101"); para poder se conectar ao IP do server;
